const COORDS_COPY_SVG = `
<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    <path style="fill:currentColor" d="M9 7c-5 0-5 5-5 5s0 5 5 5h2v-2H9c-3 0-3-3-3-3s0-3 3-3h2V7Zm4 0v2h2c3 0 3 3 3 3s0 3-3 3h-2v2h2c5 0 5-5 5-5s0-5-5-5Zm-4 4v2h6v-2Z"/>
</svg>
`;
...
const coordsPopupContent = (coordinates) => {
    ...
    copyButton.innerHTML = COORDS_COPY_SVG;
    ...
    copyButton.addEventListener('click', async () => {
        try {
            await navigator.clipboard.writeText(linkToCoordinates);
            copiedText.style.display = 'inline';
            setTimeout(() => {
                copiedText.style.display = 'none';
            }, 2000);
        } catch (err) {
            console.error('Не вдалося скопіювати посилання в буфер обміну: ', err);
        }
    });
